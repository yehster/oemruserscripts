...
{
//name=GM_getValue("patientLNAMEA");
//alert(name);

    $("#"+asContID['txtPatLNAME']).val(GM_getValue("patientLNAMEA"));
    $("#"+asContID['txtPatFNAME']).val(GM_getValue("patientFNAMEA"));
    
    GM_setValue("searchState","searching") ;
 $("#"+asContID['btnSearch']).focus();
...
patName=$("span.title").text();
                ...
                fname=splitName[1];
                lname=splitName[0];
GM_setValue("patientFNAMEA",fname);
GM_setValue("patientLNAMEA",lname);
